...
!function (t, i, e) {
    ...
    s.prototype.extend = function () {
        ...
        for (var o = i.createElement("div"), n = !1, r = null, a = !1, h = null, l = null, p = 0, m = this.vendors.length; m > p; p++) if (null !== this.vendors[p] ? (h = this.vendors[p][0] + "transform", l = this.vendors[p][1] + "Transform") : (h = "transform", l = "transform"), o.style[l] !== e) {
            n = !0;
            break
        }
        switch (s) {
            ...
            case"3D":
                if (n) {
                    var c = i.body || i.createElement("body"), u = i.documentElement, y = u.style.overflow, d = !1;
        ...
        if (!o) for (var n = 0, r = this.vendors.length; r > n; n++) if (o = null !== this.vendors[n] ? this.camelCase(this.vendors[n][1] + "-" + i) : i, t.style[o] !== e) {
        ...
        for (var e = 0, s = this.layers.length; s > e; e++) {
            var o = this.layers[e], n = this.depthsX[e], r = this.depthsY[e],
                a = this.vx * (n * (this.invertX ? -1 : 1)), h = this.vy * (r * (this.invertY ? -1 : 1));
            this.setPosition(o, a, h)
        }
        this.raf = requestAnimationFrame(this.onAnimationFrame)
    }, s.prototype.rotate = function (t, i) {
        var e = (event.beta || 0) / n, s = (event.gamma || 0) / n, o = this.wh > this.ww;
...
(function (e) {
    ...
    e.cleanData = function (t) {
        ...
        }), a.prototype = e.widget.extend(o, {widgetEventPrefix: n ? o.widgetEventPrefix || t : t}, r, {
            constructor: a,
            namespace: h,
            widgetName: t,
            widgetFullName: l
        ...
        var n, a = Math.max, o = Math.abs, r = /left|center|right/, h = /top|center|bottom/,
            l = /[\+\-]\d+(\.[\d]+)?%?/, u = /^\w+/, c = /%$/, d = e.fn.position;
        e.position = {
            scrollbarWidth: function () {
                ...
                var i = e(t || window), s = e.isWindow(i[0]), n = !!i[0] && 9 === i[0].nodeType, a = !s && !n;
                return {
                    element: i,
                    isWindow: s,
                    isDocument: n,
                    offset: a ? e(t).offset() : {left: 0, top: 0},
            ...
            n = e.extend({}, n);
            var c, p, f, m, g, v, _ = e(n.of), b = e.position.getWithinInfo(n.within), y = e.position.getScrollInfo(b),
                x = (n.collision || "flip").split(" "), k = {};
            return v = s(_), _[0].preventDefault && (n.at = "left top"), p = v.width, f = v.height, m = v.offset, g = e.extend({}, m), e.each(["my", "at"], function () {
                ...
                var s, r, h = e(this), l = h.outerWidth(), u = h.outerHeight(), d = i(this, "marginLeft"),
                    v = i(this, "marginTop"), w = l + d + i(this, "marginRight") + y.width,
                    T = u + v + i(this, "marginBottom") + y.height, D = e.extend({}, g),
                ...
                "right" === n.my[0] ? D.left -= l : "center" === n.my[0] && (D.left -= l / 2), "bottom" === n.my[1] ? D.top -= u : "center" === n.my[1] && (D.top -= u / 2), D.left += S[0], D.top += S[1], s = {
                    ...
                    var t = m.left - D.left, i = t + p - l, s = m.top - D.top, r = s + f - u, c = {
                ...
                }), h.offset(e.extend(D, {using: r}))
            })
        }, e.ui.position = {
            fit: {
                left: function (e, t) {
                    var i, s = t.within, n = s.isWindow ? s.scrollLeft : s.offset.left, o = s.width,
                        r = e.left - t.collisionPosition.marginLeft, h = n - r, l = r + t.collisionWidth - o - n;
                    ...
                    var i, s = t.within, n = s.isWindow ? s.scrollTop : s.offset.top, o = t.within.height,
                        r = e.top - t.collisionPosition.marginTop, h = n - r, l = r + t.collisionHeight - o - n;
                ...
                left: function (e, t) {
                    ...
                    var i, s, n = t.within, a = n.offset.top + n.scrollTop, r = n.height,
                        ...
                        u = l - h, c = l + t.collisionHeight - r - h, d = "top" === t.my[1],
        ...
        tabbable: function (t) {
            var i = e.attr(t, "tabindex"), s = null != i;
    ...
    e(document).on("mouseup", function () {
        ...
        _blurActiveElement: function (t) {
            var i = e.ui.safeActiveElement(this.document[0]), s = e(t.target);
        ...
        _drop: function (t, i) {
            ...
            return s && (s.currentItem || s.element)[0] !== this.element[0] ? (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                return i.options.greedy && !i.options.disabled && i.options.scope === s.options.scope && i.accept.call(i.element[0], s.currentItem || s.element) && c(s, e.extend(i, {offset: i.element.offset()}), i.options.tolerance, t) ? (n = !0, !1) : void 0
    ...
    var c = e.ui.intersect = function () {
        ...
        return function (t, i, s, n) {
            ...
            var a = (t.positionAbs || t.position.absolute).left + t.margins.left,
                ...
                h = o + t.helperProportions.height, l = i.offset.left, u = i.offset.top, c = l + i.proportions().width,
    ...
    e.ui.ddmanager = {
        ...
        _setupHandles: function () {
            var t, i, s, n, a, o = this.options, r = this;
            if (this.handles = o.handles || (e(".ui-resizable-handle", this.element).length ? {
                ...
                ne: ".ui-resizable-ne",
                nw: ".ui-resizable-nw"
            } : "e,s,se"), this._handles = e(), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), s = this.handles.split(","), this.handles = {}, i = 0; s.length > i; i++) t = e.trim(s[i]), n = "ui-resizable-" + t, a = e("<div>"), this._addClass(a, "ui-resizable-handle " + n), a.css({zIndex: o.zIndex}), this.handles[t] = ".ui-resizable-" + t, this.element.append(a);
        ...
        _respectSize: function (e) {
            var t = this._vBoundaries, i = this.axis, s = this._isNumber(e.width) && t.maxWidth && t.maxWidth < e.width,
                ...
                h = this.originalPosition.top + this.originalSize.height, l = /sw|nw|w/.test(i), u = /nw|ne|n/.test(i);
        ...
        _mouseDrag: function (t) {
            if (this.dragged = !0, !this.options.disabled) {
                ...
                return a > r && (i = r, r = a, a = i), o > h && (i = h, h = o, o = i), this.helper.css({
                    ...
                    var i = e.data(this, "selectable-item"), l = !1, u = {};
        ...
        _createPlaceholder: function (t) {
            ...
            s.placeholder && s.placeholder.constructor !== String || (i = s.placeholder, s.placeholder = {
                element: function () {
                    var s = t.currentItem[0].nodeName.toLowerCase(), n = e("<" + s + ">", t.document[0]);
        ...
        _eventHandler: function (t) {
            var i, s, n = this.options, a = this.active, o = e(t.currentTarget), r = o[0] === a[0],
                h = r && n.collapsible, l = h ? e() : o.next(), u = a.next(),
        ...
        _animate: function (e, t, i) {
            var s, n, a, o = this, r = 0, h = e.css("box-sizing"), l = e.length && (!t.length || e.index() < t.index()),
                u = this.options.animate || {}, c = l && u.down || u, d = function () {
                    o._toggleComplete(i)
                };
        ...
        refresh: function () {
            var t, i, s, n, a, o = this, r = this.options.icons.submenu, h = this.element.find(this.options.menus);
    ...
    e.widget("ui.controlgroup", {
        ...
        _initWidgets: function () {
            ...
            e.each(this.options.items, function (s, n) {
                ...
                return n ? "controlgroupLabel" === s ? (a = t.element.find(n), a.each(function () {
                    ...
                    var n = e(this), a = n[s]("instance"), r = e.widget.extend({}, o);
        ...
        _callChildMethod: function (t) {
            this.childWidgets.each(function () {
                var i = e(this), s = i.data("ui-controlgroup-data");
                s && s[t] && s[t]()
            })
        },
        ...
        _getRadioGroup: function () {
            var t, i = this.element[0].name, s = "input[name='" + e.ui.escapeSelector(i) + "']";
        ...
        _updateIcon: function (t, i) {
            var s = "iconPosition" !== t, n = s ? this.options.iconPosition : i, a = "top" === n || "bottom" === n;
    ...
    }), e.ui.button, e.extend(e.ui, {datepicker: {version: "1.12.1"}});
    var p;
    e.extend(s.prototype, {
        ...
        _updateDatepicker: function (t) {
            ...
            var i, s = this._getNumberOfMonths(t), n = s[1], o = 17, r = t.dpDiv.find("." + this._dayOverClass + " a");
        ...
        parseDate: function (t, i, s) {
            ...
            var n, a, o, r, h = 0, l = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff,
                ...
                y = function (e) {
                    ...
                    var t = y(e), s = "@" === e ? 14 : "!" === e ? 20 : "y" === e && t ? 4 : "o" === e ? 3 : 2,
            ...
            for (n = 0; t.length > n; n++) if (b) "'" !== t.charAt(n) || y("'") ? w() : b = !1; else switch (t.charAt(n)) {
                case"d":
                    v = x("d");
                    break;
                case"D":
        ...
        _generateHTML: function (e) {
            var t, i, s, n, a, o, r, h, l, u, c, d, p, f, m, g, v, _, b, y, x, k, w, T, D, S, M, C, N, P, A, I, H, z, F,
                E, O, j, W, L = new Date,
                R = this._daylightSavingAdjust(new Date(L.getFullYear(), L.getMonth(), L.getDate())),
                Y = this._get(e, "isRTL"), B = this._get(e, "showButtonPanel"), J = this._get(e, "hideIfNoPrevNext"),
                V = this._get(e, "navigationAsDateFormat"), K = this._getNumberOfMonths(e),
                q = this._get(e, "showCurrentAtPos"), Q = this._get(e, "stepMonths"), U = 1 !== K[0] || 1 !== K[1],
                G = this._daylightSavingAdjust(e.currentDay ? new Date(e.currentYear, e.currentMonth, e.currentDay) : new Date(9999, 9, 9)),
                X = this._getMinMaxDate(e, "min"), $ = this._getMinMaxDate(e, "max"), Z = e.drawMonth - q,
                et = e.drawYear;
        ...
        _generateMonthYearHeader: function (e, t, i, s, n, a, o, r) {
            var h, l, u, c, d, p, f, m, g = this._get(e, "changeMonth"), v = this._get(e, "changeYear"),
                _ = this._get(e, "showMonthAfterYear"), b = "<div class='ui-datepicker-title'>", y = "";
        ...
        _createButtons: function () {
            ...
            return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), e.isEmptyObject(i) || e.isArray(i) && !i.length ? (this._removeClass(this.uiDialog, "ui-dialog-buttons"), void 0) : (e.each(i, function (i, s) {
                ...
                s = e.isFunction(s) ? {
                    click: s,
                    text: i
                } : s, s = e.extend({type: "button"}, s), n = s.click, a = {
                    icon: s.icon,
        ...
        _drawButton: function () {
            var t, i = this, s = this._parseOption(this.element.find("option:selected"), this.element[0].selectedIndex);
        ...
        _renderItem: function (t, i) {
            var s = e("<li>"), n = e("<div>", {title: i.element.attr("title")});
        ...
        _createHandles: function () {
            var t, i, s = this.options, n = this.element.find(".ui-slider-handle"), a = "<span tabindex='0'></span>",
                o = [];
        ...
        _calculateNewMax: function () {
            var e = this.options.max, t = this._valueMin(), i = this.options.step, s = Math.round((e - t) / i) * i;
        ...
        _tabKeydown: function (t) {
            var i = e(e.ui.safeActiveElement(this.document[0])).closest("li"), s = this.tabs.index(i), n = !0;
        ...
        version: "1.12.1", options: {
            ...
            var i = e("<div>").attr("role", "tooltip"), s = e("<div>").appendTo(i), n = i.uniqueId().attr("id");
    ...
    var f = "ui-effects-", m = "ui-effects-style", g = "ui-effects-animated", v = e;
    e.effects = {effect: {}}, function (e, t) {
        ...
        e.expr && e.expr.filters && e.expr.filters.animated && (e.expr.filters.animated = function (t) {
            ...
            save: function (e, t) {
                ...
                return t.wrap(s), (t[0] === a || e.contains(t[0], a)) && e(a).trigger("focus"), s = t.parent(), "static" === t.css("position") ? (s.css({position: "relative"}), t.css({position: "relative"})) : (e.extend(i, {
                    position: t.css("position"),
            ...
            version: "1.12.1", define: function (t, i, s) {
                ...
                var i, s = t.css("position"), n = t.position();
                return t.css({
                ...
                var t = f + "placeholder", i = e.data(t);
            ...
            effect: function () {
                ...
                var s = t.apply(this, arguments), n = e.effects.effect[s.effect], a = n.mode, o = s.queue,
                    r = o || "fx", h = s.complete, l = s.mode, u = [], c = function (t) {
                        var i = e(this), s = e.effects.mode(i, l) || a;
                ...
                var s = e(this), n = e(t.to), a = "fixed" === n.css("position"), o = e("body"),
                    r = a ? o.scrollTop() : 0, h = a ? o.scrollLeft() : 0, l = n.offset(),
    ...
    e.effects.define("blind", "hide", function (t, i) {
        var s = {
                ...
                right: ["left", "right"]
            }, n = e(this), a = t.direction || "up", o = n.cssClip(), r = {clip: e.extend({}, o)},
        ...
        var s, n, a, o = e(this), r = t.mode, h = "hide" === r, l = "show" === r, u = t.direction || "up",
            c = t.distance, d = t.times || 5, p = 2 * d + (l || h ? 1 : 0), f = t.duration / p, m = t.easing,
            g = "up" === u || "down" === u ? "top" : "left", v = "up" === u || "left" === u, _ = 0,
            b = o.queue().length;
        ...
        var s, n = {}, a = e(this), o = t.direction || "vertical", r = "both" === o, h = r || "horizontal" === o,
            l = r || "vertical" === o;
        s = a.cssClip(), n.clip = {
        ...
        var s, n = e(this), a = t.mode, o = "show" === a, r = t.direction || "left",
        ...
        function n() {
            p.css({visibility: "visible"}), e(b).remove(), i()
        }

        var a, o, r, h, l, u, c = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, d = c, p = e(this), f = t.mode,
            m = "show" === f, g = p.show().css("visibility", "hidden").offset(), v = Math.ceil(p.outerWidth() / d),
        ...
        var s = "show" === t.mode;
        e(this).css("opacity", s ? 0 : 1).animate({opacity: s ? 1 : 0}, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: i
        ...
        var s = e(this), n = t.mode, a = "show" === n, o = "hide" === n, r = t.size || 15, h = /([0-9]+)%/.exec(r),
            l = !!t.horizFirst, u = l ? ["right", "bottom"] : ["bottom", "right"], c = t.duration / 2,
            d = e.effects.createPlaceholder(s), p = s.cssClip(), f = {clip: e.extend({}, p)},
            m = {clip: e.extend({}, p)}, g = [p[u[0]], p[u[1]]], v = s.queue().length;
        ...
        var s = e(this), n = {backgroundColor: s.css("backgroundColor")};
        "hide" === t.mode && (n.opacity = 0), e.effects.saveStyle(s), s.css({
            backgroundImage: "none",
            backgroundColor: t.color || "#ffff99"
        }).animate(n, {queue: !1, duration: t.duration, easing: t.easing, complete: i})
    }), e.effects.define("size", function (t, i) {
        var s, n, a, o = e(this), r = ["fontSize"],
            h = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
            l = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], u = t.mode, c = "effect" !== u,
            d = t.scale || "both", p = t.origin || ["middle", "center"], f = o.css("position"), m = o.position(),
            g = e.effects.scaledDimensions(o), v = t.from || g, _ = t.to || e.effects.scaledDimensions(o, 0);
        e.effects.createPlaceholder(o), "show" === u && (a = v, v = _, _ = a), n = {
            ...
            var i = e(this), s = e.effects.scaledDimensions(i), a = {
        ...
        var s = e(this), n = t.mode, a = "show" === n, o = "hide" === n, r = a || o,
            h = 2 * (t.times || 5) + (r ? 1 : 0), l = t.duration / h, u = 0, c = 1, d = s.queue().length;
        ...
        var s = 1, n = e(this), a = t.direction || "left", o = t.distance || 20, r = t.times || 3, h = 2 * r + 1,
            l = Math.round(t.duration / h), u = "up" === a || "down" === a ? "top" : "left",
            c = "up" === a || "left" === a, d = {}, p = {}, f = {}, m = n.queue().length;
        ...
        var s, n, a = e(this),
            ...
            r = t.mode, h = t.direction || "left", l = "up" === h || "down" === h ? "top" : "left",
            u = "up" === h || "left" === h, c = t.distance || a["top" === l ? "outerHeight" : "outerWidth"](!0), d = {};
...
$(function () {
    function a() {
        s = new ymaps.Map("map", {
            center: [43.27298459, 76.89963717],
            zoom: 14
        }), s.controls.remove("routeEditor").remove("trafficControl").remove("searchControl").remove("fullscreenControl").remove("rulerControl"), s.behaviors.disable(["scrollZoom"]), myCollection = new ymaps.GeoObjectCollection({}, {
            preset: "islands#orangeHomeIcon",
            draggable: !1
        }), c = new ymaps.Placemark([43.2711142, 76.89976843], {
            balloonContentHeader: '<img src="img/logo.png" alt="мебель дизайн" class="map__pic"> <span class="map__decr">Мебель дизайн 21</span>',
            balloonContentBody: "Изготовление мебели на заказ в Алматы",
            balloonContentFooter: "Алматы, Ниязбекова, 59",
            hintContent: "Алматы, Ниязбекова, 59"
        }), myCollection.add(c), s.geoObjects.add(myCollection), c.balloon.open()
    }

    $(window).resize(function () {
        $(window).width() > 768 ? ($(".portfolio__tabs-list").show(), $(".portfolio__tabs-link").click(function (a) {
            $(".portfolio__tabs-list").show()
        })) : ($(".portfolio__tabs-list").hide(), $(".portfolio__mob").click(function (a) {
            $(".portfolio__tabs-list").show()
        }), $(".portfolio__tabs-link").click(function (a) {
            $(".portfolio__tabs-list").hide()
        }))
    });
    var e = $(".hamburger"), i = $(".menu__slide"), t = $(".menu__close"), l = $(".menu__slide a");
    e.click(function (a) {
        i.toggleClass("menu_active")
    }), t.click(function (a) {
        i.removeClass("menu_active")
    }), l.click(function (a) {
        i.removeClass("menu_active")
    }), jQuery("a.scrollto").click(function () {
        return elementClick = jQuery(this).attr("href"), destination = jQuery(elementClick).offset().top, jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop: destination}, 1100), !1
    }), $(".vertikal__container").slick({
        slidesToShow: 1,
        dots: !0,
        autoplay: !0,
        autoplaySpeed: 2e3,
    ...
    o.sly({
        ...
        dynamicHandle: 0,
        clickBar: 1
    }).init(), $(".slider__tabs").not(":first").hide(), $(".portfolio__tabs-list li").click(function () {
        $(".portfolio__tabs-list li").removeClass("active").eq($(this).index()).addClass("active"), $(".slider__tabs").hide().eq($(this).index()).fadeIn(), $(".frame").sly("reload"), $("#sl9").sly("reload"), $("#sl8").sly("reload"), $("#sl7").sly("reload"), $("#sl6").sly("reload"), $("#sl5").sly("reload"), $("#sl4").sly("reload"), $("#sl3").sly("reload"), $("#sl2").sly("reload"), $("#sl1").sly("reload")
    }).eq(0).addClass("active"), $(".kitchen-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".detmebel-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".krovati-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".vanna-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".torg-bar-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
        ...
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".stenki-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".stoli-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
    }), $(".cupe-img").magnificPopup({
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
        gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]}
        ...
        iframe: {
            patterns: {
                youtube: {
                    index: "youtube.com/",
                    id: "v=",
                    src: "//www.youtube.com/embed/%id%?autoplay=1&rel=0&showinfo=0&controls=1"
                }
            }
        }
    }), $(".box__item").not(":first").hide(), $(".techo__tab").click(function () {
        $(".techo__tab").removeClass("active").eq($(this).index()).addClass("active"), $(".box__item").hide().eq($(this).index()).fadeIn()
    }).eq(0).addClass("active"), $(".comments__box-video").not(":first").hide(), $(".comments__item").click(function () {
        $(".comments__item").removeClass("active").eq($(this).index()).addClass("active"), $(".comments__box-video").hide().eq($(this).index()).fadeIn(), $("iframe").stopVideo()
    }).eq(0).addClass("active"), $("a").click(function () {
        $("#" + $(this).data("modal")).css("display", "block")
    }), $("a").click(function () {
        $("#" + $(this).data("modal2")).css("display", "block")
    }), $("a").click(function () {
        $("#" + $(this).data("modal3")).css("display", "block")
    }), $("a").click(function () {
        $("#" + $(this).data("modal4")).css("display", "block")
    }), $("a[data-remodal-target=modal2], a[data-remodal-target=modal3], a[data-remodal-target=modal4]").click(function () {

        var a = $(this).data("form");
        $(".form-callback [name=admin-data]").val(a)
    }), $("select").selectize({create: !1}), $("form").submit(function () {
        var a = $(this);
        return $.ajax({type: "GET", url: "mail.php", data: a.serialize()}).done(function () {
            $(".remodal .success").addClass("active"), setTimeout(function () {
                $(".remodal .success").removeClass("active"), a.trigger("reset"), $(".remodal-close").click()
            }, 3e3)
        }), !1
    }), ymaps.ready(a);
    var s, c
}), r(function () {
    if (document.getElementsByClassName) var a = document.getElementsByClassName("youtube"); else var a = function (a, e) {
        for (var i = [], t = new RegExp("(^| )" + e + "( |$)"), l = a.getElementsByTagName("*"), o = 0, n = l.length; o < n; o++) t.test(l[o].className) && i.push(l[o]);
        return i
    }(document.body, "youtube");
    for (var e = a.length, i = 0; i < e; i++) {
        a[i].style.backgroundImage = "url(http://i.ytimg.com/vi/" + a[i].id + "/maxresdefault.jpg)";
        var t = document.createElement("div");
        t.setAttribute("class", "play"), a[i].appendChild(t), a[i].onclick = function () {
            var a = document.createElement("iframe"),
                e = "https://www.youtube.com/embed/" + this.id + "?autoplay=1&autohide=1&rel=0&showinfo=0&controls=1&enablejsapi=1";
            this.getAttribute("data-params") && (e += "&" + this.getAttribute("data-params")), a.setAttribute("src", e), a.setAttribute("frameborder", "0"), a.style.width = this.style.width, a.style.height = this.style.height, this.parentNode.replaceChild(a, this)
        }
    }
    jQuery(".comments__item").click(function () {
        $(".video-stream").each(function (a) {
            return $(this).attr("src", $(this).attr("src")), !1
        })
